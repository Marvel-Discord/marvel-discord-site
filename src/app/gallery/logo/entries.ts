...
export const galleryEntries: GalleryEntry[] = [
  ...
  {
    title: "Wonder Man",
    description: "Logo and banner for the Wonder Man miniseries.",
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Logo and banner for season 2 of the Daredevil: Born Again series.",
    imageUrls: [
  ...
  },
  {
    ...
    description: "Logo and banner for Pride Month 2026.",
    imageUrls: [
  ...
  {
    title: "X-Men '97 S2",
    description: "Logo and banner for season 2 of the X-Men '97 series.",
    imageUrls: [
